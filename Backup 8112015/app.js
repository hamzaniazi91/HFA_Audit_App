...
.factory('Post', function($resource,$http , transformRequestAsFormPost) {
  ...
  return $resource('http://192.168.1.104/mainhalal/index.php/staff/Numbers/staff/');
})

.controller('MainCtrl', function($scope, Post , $http , transformRequestAsFormPost) {
  // Get all posts
$scope.data = {};
...
/////form 1
    $scope.submit = function(task){
        var link = 'http://192.168.1.104/mainhalal/index.php/staff/Numbers/staff/';

        return $http({method : "POST",
     url : link,
     data : {first_name : task.firstName ,
      last_name : task.lastName ,
      email : task.email , 
      audit_date : clickedDate._d ,
...
$scope.submit2 = function(task2){
        var link2 = 'http://192.168.1.104/mainhalal/index.php/staff/Numbers/staff/';

        return $http({method : "POST",
     url : link2,
     data : {city : task2.city ,
      country : task2.country  },
     transformRequest: transformRequestAsFormPost,
     headers : {'Content-Type': "application/x-www-form-urlencoded"}
     //headers : {'Accept' : 'application/json'}
   }).success(function(data) {
